        ...
        <Row>
          ...
          >
            <div className="buyReferralsCardMain">
              <div className="buySellTitle">{activeTab ? "GET TOKEN" : "DONATE"}</div>
              ...
              {!activeTab ? (
                    ...
                    <div className="buyReferralsForkPart">
                      <div className="buyReferralsForkPartUp">
                        <div className="buyReferralsForkPartsLeft">
                          ...
                          <div className="buyReferralsPartLeftText">DTK</div>
                        </div>
                        {address !== undefined && (
                ...
                <>
                  ...
                  {bnbValue !== null && bnbValue !== "" && bnbValue > 0 ? (
                    ...
                    <button className="buyReferralsButtonOpa">GET</button>
                  )}
                </>
              )}
            </div>
