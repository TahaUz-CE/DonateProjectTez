...
contract DonateTracking is ERC20, Ownable {
    ...
    uint256 public LabelWalletLimit = 50 ether;
    ...
    event UpdateBuyFees(uint256 liquidityFeeOnBuy, uint256 projectFeeOnBuy, uint256 LabelFeeOnBuy);
    ...
    event LabelWalletLimitUpdated(uint256 LabelWalletLimit);
    event SwapTokensAtAmountUpdated(uint256 swapTokensAtAmount);

    constructor () ERC20("Donate Tracking", "DTK") 
    {   
        ...
        _totalFeesOnBuy    = liquidityFeeOnBuy  + projectFeeOnBuy + LabelFeeOnBuy;
...
//------------------LabelSystem------------------//
    function setlabelWalletLimit(uint256 newAmount) external onlyOwner{
        LabelWalletLimit = newAmount;
    ...
    function getAlllabels() external view returns(LabelInfo[] memory){
        ...
        LabelInfo[] memory list = new LabelInfo[](length);
    ...
    function getlabelByIndex(uint256 index) external view returns(LabelInfo memory){
        require(index < _labels.length(), "Index out of bounds");
        return LabelInfo(
                _labels.at(index),
    ...
    function getlabelByCode(bytes32 _code) external view returns(LabelInfo memory){
        return LabelInfo(
    ...
    function getlabelBetween(uint256 start, uint256 end) external view returns(LabelInfo[] memory){
        require(start < end, "Start must be less than end");
        require(end < _labels.length(), "End must be less than labels length");
    ...
    function generateMyLabel(string memory _labeledCode) external{
        ...
        addressToLabels[address(msg.sender)].myLabelCode = _result;
    }
    
    function setlabelToSystem(string memory _labeledCode) external{
        ...
        require(addressToLabels[address(msg.sender)].myLabelCode != _result, "Can not use own label code.");
        require(LabelCodestoAddress[_result] != address(0), "Invalid label code.");

        addressToLabels[address(msg.sender)].labelCode = _result;
        _labels.add(LabelCodestoAddress[_result]);
    }
...
//------------------FeeManagement------------------//
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _projectFeeOnBuy, uint256 _LabelFeeOnBuy) external onlyOwner {
        liquidityFeeOnBuy = _liquidityFeeOnBuy;
        projectFeeOnBuy = _projectFeeOnBuy;
        LabelFeeOnBuy = _LabelFeeOnBuy;

        _totalFeesOnBuy   = liquidityFeeOnBuy + projectFeeOnBuy + LabelFeeOnBuy ;

        require(_totalFeesOnBuy  <= 10, "Total Buy Fees cannot be more than 10%");

        emit UpdateBuyFees(liquidityFeeOnBuy, projectFeeOnBuy, LabelFeeOnBuy);
    }
...
//------------------Transfer------------------//
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (_isExcludedFromFees[from] || 
            ...
            if(_totalFeesOnBuy == LabelFeeOnBuy){
                amount -= LabelTokens;
            }
